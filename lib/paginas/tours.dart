...
class ToursPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tours Disponibles', style: TextStyle(color: Colors.black87)),
        backgroundColor: const Color(0xFFA5D6A7),
        elevation: 0,
      ),
      body: Center(
        child: Image.network('https://raw.githubusercontent.com/Alejandro-Aceves/Imagenes-Para-Flutter-Alejandro-Aceves-6J-11-FEB-2026/refs/heads/main/NuevaYork.jpg'),
      ),
